...
export const pinch = Macro.if_(`gotjump`, Macro.attack()).item(`jar full of wind`).attack().item(`jar full of wind`).attack().item(`jar full of wind`).attack().item(`jar full of wind`).attack().item(`jar full of wind`).attack();
